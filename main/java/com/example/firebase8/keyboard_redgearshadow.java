...
public class keyboard_redgearshadow extends AppCompatActivity implements PaymentResultListener {
    ViewPager viewPager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_keyboard_redgearshadow);

        Objects.requireNonNull(getSupportActionBar()).setTitle("REDGEAR SHADOW BLADE MECHANICAL KEYBOARD");
...
//        This is for image slider
        ...
        imageList.add(R.drawable.k_redgearshadow_1);
        imageList.add(R.drawable.k_redgearshadow_2);
        imageList.add(R.drawable.k_redgearshadow_3);
        imageList.add(R.drawable.k_redgearshadow_4);
    ...
    private void addingToCartList() {
        ...
        cartListRef.child("User Cart KEYBOARD Cart List").child("REDGEAR SHADOW BLADE MECHANICAL KEYBOARD").updateChildren(cartMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Toast.makeText(keyboard_redgearshadow.this, "Added to cart", Toast.LENGTH_SHORT).show();

                }
                else{
                    Toast.makeText(keyboard_redgearshadow.this, "An Error Occurred", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        buyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(keyboard_redgearshadow.this, "You are now on RazorPay Payment Gateway", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void paymentNow(String amount) {
        ...
        checkout.setImage(R.drawable.k_redgearshadow_1);
