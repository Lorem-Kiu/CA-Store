...
public class cpu_electrobot_bolt extends AppCompatActivity implements PaymentResultListener {
    ViewPager viewPager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cpu_electrobot_bolt);

        progressDialog = new ProgressDialog(this);

        Objects.requireNonNull(getSupportActionBar()).setTitle("ELECTROBOT BOLD GAMING PC CPU");
        ...
        imageList.add(R.drawable.cpu_electrobol_bolt_1);
        imageList.add(R.drawable.cpu_electrobol_bolt_2);
        imageList.add(R.drawable.cpu_electrobol_bolt_3);
        imageList.add(R.drawable.cpu_electrobol_bolt_4);
    ...
    private void addingToCartList() {
        ...
        cartListRef.child("User Cart CPU Cart List").child("ELECTROBOT BOLD GAMING PC CPU").updateChildren(cartMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Toast.makeText(cpu_electrobot_bolt.this, "Added to cart", Toast.LENGTH_SHORT).show();
                }
                else{
                    Toast.makeText(cpu_electrobot_bolt.this, "An Error Occurred", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        buyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(cpu_electrobot_bolt.this, "You are now on RazorPay Payment Gateway", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void paymentNow(String amount) {
        ...
        checkout.setImage(R.drawable.cpu_electrobol_bolt_1);
