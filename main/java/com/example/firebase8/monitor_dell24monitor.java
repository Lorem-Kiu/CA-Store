...
public class monitor_dell24monitor extends AppCompatActivity implements PaymentResultListener {
    ViewPager viewPager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_monitor_dell24monitor);

        Objects.requireNonNull(getSupportActionBar()).setTitle("DELL 24 INCHES S2421HM MONITOR");
        ...
        imageList.add(R.drawable.monitor_dell2_1);
        imageList.add(R.drawable.monitor_dell2_2);
        imageList.add(R.drawable.monitor_dell2_3);
        imageList.add(R.drawable.monitor_dell2_4);
    ...
    private void addingToCartList() {
        ...
        cartListRef.child("User Cart MONITOR Cart List").child("DELL 24 INCHES S2421HM MONITOR").updateChildren(cartMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Toast.makeText(monitor_dell24monitor.this, "Added to cart", Toast.LENGTH_SHORT).show();
                }
                else{
                    Toast.makeText(monitor_dell24monitor.this, "An Error Occurred", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        buyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(monitor_dell24monitor.this, "You are now on RazorPay Payment Gateway", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void paymentNow(String amount) {
        ...
        checkout.setImage(R.drawable.hpx1000_1);
