...
public class cpu_applemacmini extends AppCompatActivity implements PaymentResultListener {
    ViewPager viewPager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cpu_applemacmini);

        Objects.requireNonNull(getSupportActionBar()).setTitle("APPLE MAC MINI CPU");
        ...
        imageList.add(R.drawable.cpu_applemacmini_1);
        imageList.add(R.drawable.cpu_applemacmini_2);
        imageList.add(R.drawable.cpu_applemacmini_3);
        imageList.add(R.drawable.cpu_applemacmini_4);
    ...
    private void addingToCartList() {
        ...
        cartListRef.child("User Cart CPU Cart List").child("APPLE MAC MINI CPU").updateChildren(cartMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Toast.makeText(cpu_applemacmini.this, "Added to cart", Toast.LENGTH_SHORT).show();
                }
                else{
                    Toast.makeText(cpu_applemacmini.this, "An Error Occurred", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        buyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(cpu_applemacmini.this, "You are now on RazorPay Payment Gateway", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void paymentNow(String amount) {
        ...
        checkout.setImage(R.drawable.cpu_applemacmini_1);
