...
public class printer_hpdeskjet_1212 extends AppCompatActivity implements PaymentResultListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_printer_hpdeskjet1212);

        Objects.requireNonNull(getSupportActionBar()).setTitle("HP DESKJET 1212 COLOR PRINTER");
        ...
        imageList.add(R.drawable.pr_hpdeskjet_1212_1);
        imageList.add(R.drawable.pr_hpdeskjet_1212_2);
        imageList.add(R.drawable.pr_hpdeskjet_1212_3);
        imageList.add(R.drawable.pr_hpdeskjet_1212_4);
    ...
    private void addingToCartList() {
        ...
        cartListRef.child("User Cart PRINTER Cart List").child("HP DESKJET 1212 COLOR PRINTER").updateChildren(cartMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Toast.makeText(printer_hpdeskjet_1212.this, "Added to cart", Toast.LENGTH_SHORT).show();

                }
                else{
                    Toast.makeText(printer_hpdeskjet_1212.this, "An Error Occurred", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        buyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(printer_hpdeskjet_1212.this, "You are now on RazorPay Payment Gateway", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void paymentNow(String amount) {
        ...
        checkout.setImage(R.drawable.pr_hpdeskjet_1212_1);
