...
public class keyboard_logitech_k480 extends AppCompatActivity implements PaymentResultListener {
    ViewPager viewPager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_keyboard_logitech_k480);

        progressDialog = new ProgressDialog(this);

        Objects.requireNonNull(getSupportActionBar()).setTitle("LOGITECH K480 WIRELESS KEYBOARD");
...
//        This is for image slider
        ...
        imageList.add(R.drawable.k_logitech480_1);
        imageList.add(R.drawable.k_logitech480_2);
        imageList.add(R.drawable.k_logitech480_3);
        imageList.add(R.drawable.k_logitech480_4);
    ...
    private void addingToCartList() {
        ...
        cartListRef.child("User Cart KEYBOARD Cart List").child("LOGITECH K480 WIRELESS KEYBOARD").updateChildren(cartMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Toast.makeText(keyboard_logitech_k480.this, "Added to cart", Toast.LENGTH_SHORT).show();

                }
                else{
                    Toast.makeText(keyboard_logitech_k480.this, "An Error Occurred", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        buyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(keyboard_logitech_k480.this, "You are now on RazorPay Payment Gateway", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void paymentNow(String amount) {
        ...
        checkout.setImage(R.drawable.k_logitech480_1);
