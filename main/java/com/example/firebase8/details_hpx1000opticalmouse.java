...
public class details_hpx1000opticalmouse extends AppCompatActivity implements PaymentResultListener {
    ViewPager viewPager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_details_hpx1000opticalmouse);

        Objects.requireNonNull(getSupportActionBar()).setTitle("HP X1000 OPTICAL MOUSE");
...
//        This is for image slider
        ...
        imageList.add(R.drawable.hpx1000_1);
        imageList.add(R.drawable.hpx1000_2);
        imageList.add(R.drawable.hpx1000_3);
        imageList.add(R.drawable.hpx1000_4);
    ...
    private void addingToCartList() {
        ...
        cartListRef.child("User Cart HP X1000 OPTICAL MOUSE List").updateChildren(cartMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Toast.makeText(details_hpx1000opticalmouse.this, "Added to cart", Toast.LENGTH_SHORT).show();

                }
                else{
                    Toast.makeText(details_hpx1000opticalmouse.this, "An Error Occurred", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        buyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(details_hpx1000opticalmouse.this, "You are now on RazorPay Payment Gateway", Toast.LENGTH_SHORT).show();
            }
        });
