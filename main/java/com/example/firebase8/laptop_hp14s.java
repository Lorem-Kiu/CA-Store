...
public class laptop_hp14s extends AppCompatActivity implements PaymentResultListener {
    ViewPager viewPager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_laptop_hp14s);

        Objects.requireNonNull(getSupportActionBar()).setTitle("HP 14s 11th GEN INTEL CORE i3 LAPTOP");
        ...
        imageList.add(R.drawable.lp_hp14s_1);
        imageList.add(R.drawable.lp_hp14s_2);
        imageList.add(R.drawable.lp_hp14s_3);
        imageList.add(R.drawable.lp_hp14s_4);
    ...
    private void addingToCartList() {
        ...
        cartListRef.child("User Cart LAPTOP Cart List").child("HP 14s 11th GEN INTEL CORE i3 LAPTOP").updateChildren(cartMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Toast.makeText(laptop_hp14s.this, "Added to cart", Toast.LENGTH_SHORT).show();
                }
                else{
                    Toast.makeText(laptop_hp14s.this, "An Error Occurred", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        buyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(laptop_hp14s.this, "You are now on RazorPay Payment Gateway", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void paymentNow(String amount) {
        ...
        checkout.setImage(R.drawable.lp_hp14s_1);
