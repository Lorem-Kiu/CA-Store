...
public class keyboard_cosmicbyte extends AppCompatActivity implements PaymentResultListener {
    ViewPager viewPager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_keyboard_cosmicbyte);

        progressDialog = new ProgressDialog(this);

        Objects.requireNonNull(getSupportActionBar()).setTitle("COSMIC BYTE KEYBOARD");
...
//        This is for image slider
        ...
        imageList.add(R.drawable.k_cosmicbyte_1);
        imageList.add(R.drawable.k_cosmicbyte_2);
        imageList.add(R.drawable.k_cosmicbyte_3);
        imageList.add(R.drawable.k_cosmicbyte_4);
    ...
    private void addingToCartList() {
        ...
        cartListRef.child("User Cart KEYBOARD Cart List").child("COSMIC BYTE KEYBOARD").updateChildren(cartMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Toast.makeText(keyboard_cosmicbyte.this, "Added to cart", Toast.LENGTH_SHORT).show();
        ...
        buyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(keyboard_cosmicbyte.this, "You are now on RazorPay Payment Gateway", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void paymentNow(String amount) {
        ...
        checkout.setImage(R.drawable.k_cosmicbyte_1);
