...
public class monitor_appleimac extends AppCompatActivity implements PaymentResultListener {
    ViewPager viewPager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_monitor_appleimac);

        Objects.requireNonNull(getSupportActionBar()).setTitle("APPLE IMAC MONITOR");
        ...
        imageList.add(R.drawable.monitor_appleimac_1);
        imageList.add(R.drawable.monitor_appleimac_2);
        imageList.add(R.drawable.monitor_appleimac_3);
        imageList.add(R.drawable.monitor_appleimac_4);
    ...
    private void addingToCartList() {
        ...
        cartListRef.child("User Cart MONITOR Cart List").child("APPLE IMAC MONITOR").updateChildren(cartMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Toast.makeText(monitor_appleimac.this, "Added to cart", Toast.LENGTH_SHORT).show();
                }
                else{
                    Toast.makeText(monitor_appleimac.this, "An Error Occurred", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        buyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(monitor_appleimac.this, "You are now on RazorPay Payment Gateway", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void paymentNow(String amount) {
        ...
        checkout.setImage(R.drawable.monitor_appleimac_1);
