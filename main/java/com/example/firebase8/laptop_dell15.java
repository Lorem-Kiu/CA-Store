...
public class laptop_dell15 extends AppCompatActivity implements PaymentResultListener {
    ViewPager viewPager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_laptop_dell15);

        Objects.requireNonNull(getSupportActionBar()).setTitle("DELL 15S LAPTOP");
        ...
        imageList.add(R.drawable.lp_dell15_1);
        imageList.add(R.drawable.lp_dell15_2);
        imageList.add(R.drawable.lp_dell15_3);
        imageList.add(R.drawable.lp_dell15_4);
    ...
    private void addingToCartList() {
        ...
        cartListRef.child("User Cart LAPTOP Cart List").child("DELL 15S LAPTOP").updateChildren(cartMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Toast.makeText(laptop_dell15.this, "Added to cart", Toast.LENGTH_SHORT).show();
                }
                else{
                    Toast.makeText(laptop_dell15.this, "An Error Occurred", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        buyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(laptop_dell15.this, "You are now on RazorPay Payment Gateway", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void paymentNow(String amount) {
        ...
        checkout.setImage(R.drawable.lp_dell15_1);
