...
public class printer_brotherdcp_t520w extends AppCompatActivity implements PaymentResultListener {

    ViewPager viewPager;

    TextView productname, modelname, style, sheetsize, connectivity, brand, price, warranty, features, manufacturer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_printer_brotherdcp_t520w);

        Objects.requireNonNull(getSupportActionBar()).setTitle("BROTHER DCP-T520W PRINTER");
        ...
        sheetsize = (TextView) findViewById(R.id.sheetsize);
        ...
        imageList.add(R.drawable.pr_brotherdcp_t520w_1);
        imageList.add(R.drawable.pr_brotherdcp_t520w_2);
        imageList.add(R.drawable.pr_brotherdcp_t520w_3);
        imageList.add(R.drawable.pr_brotherdcp_t520w_4);
    ...
    private void addingToCartList() {
        ...
        cartMap.put("style", style.getText().toString());
        cartMap.put("sheet size", sheetsize.getText().toString());
        ...
        cartListRef.child("User Cart PRINTER Cart List").child("BROTHER DCP-T520W PRINTER").updateChildren(cartMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Toast.makeText(printer_brotherdcp_t520w.this, "Added to cart", Toast.LENGTH_SHORT).show();

                }
                else{
                    Toast.makeText(printer_brotherdcp_t520w.this, "An Error Occurred", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        buyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(printer_brotherdcp_t520w.this, "You are now on RazorPay Payment Gateway", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void paymentNow(String amount) {
        ...
        checkout.setImage(R.drawable.pr_brotherdcp_t520w_1);
