...
public class monitor_lg24inch extends AppCompatActivity implements PaymentResultListener {
    ViewPager viewPager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_monitor_lg24inch);

        Objects.requireNonNull(getSupportActionBar()).setTitle("LG 24 INCHES 24MP60G MONITOR");
        ...
        imageList.add(R.drawable.monitor_lg_1);
        imageList.add(R.drawable.monitor_lg_2);
        imageList.add(R.drawable.monitor_lg_3);
        imageList.add(R.drawable.monitor_lg_4);
    ...
    private void addingToCartList() {
        ...
        cartListRef.child("User Cart MONITOR Cart List").child("LG 24 INCHES 24MP60G MONITOR").updateChildren(cartMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Toast.makeText(monitor_lg24inch.this, "Added to cart", Toast.LENGTH_SHORT).show();
                }
                else{
                    Toast.makeText(monitor_lg24inch.this, "An Error Occurred", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        buyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(monitor_lg24inch.this, "You are now on RazorPay Payment Gateway", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void paymentNow(String amount) {
        ...
        checkout.setImage(R.drawable.monitor_lg_1);
