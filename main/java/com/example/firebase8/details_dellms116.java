...
public class details_dellms116 extends AppCompatActivity implements PaymentResultListener {
    ViewPager viewPager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_details_dellms116);

        Objects.requireNonNull(getSupportActionBar()).setTitle("DELL MS116 1000DPI USB WIRED OPTICAL MOUSE");
...
//        This is for image slider
        ...
        imageList.add(R.drawable.dellms116_1);
        imageList.add(R.drawable.dellms116_2);
        imageList.add(R.drawable.dellms116_3);
        imageList.add(R.drawable.dellms116_4);
    ...
    private void addingToCartList() {
        ...
        cartListRef.child("User Cart DELL MS 116 MOUSE List").updateChildren(cartMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Toast.makeText(details_dellms116.this, "Added to cart", Toast.LENGTH_SHORT).show();
        ...
        buyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(details_dellms116.this, "You are now on RazorPay Payment Gateway", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void paymentNow(String amount) {
        ...
        checkout.setImage(R.drawable.dellms116_1);
