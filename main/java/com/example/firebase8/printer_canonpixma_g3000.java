...
public class printer_canonpixma_g3000 extends AppCompatActivity implements PaymentResultListener {
    ViewPager viewPager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_printer_canonpixma_g3000);

        Objects.requireNonNull(getSupportActionBar()).setTitle("CANON PIXMA G3000 PRINTER");
        ...
        imageList.add(R.drawable.pr_canonpixma_g3000_1);
        imageList.add(R.drawable.pr_canonpixma_g3000_2);
        imageList.add(R.drawable.pr_canonpixma_g3000_3);
        imageList.add(R.drawable.pr_canonpixma_g3000_4);
    ...
    private void addingToCartList() {
        ...
        cartListRef.child("User Cart PRINTER Cart List").child("CANON PIXMA G3000 PRINTER").updateChildren(cartMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Toast.makeText(printer_canonpixma_g3000.this, "Added to cart", Toast.LENGTH_SHORT).show();

                }
                else{
                    Toast.makeText(printer_canonpixma_g3000.this, "An Error Occurred", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        buyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(printer_canonpixma_g3000.this, "You are now on RazorPay Payment Gateway", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void paymentNow(String amount) {
        ...
        checkout.setImage(R.drawable.pr_canonpixma_g3000_1);
