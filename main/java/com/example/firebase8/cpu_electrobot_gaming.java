...
public class cpu_electrobot_gaming extends AppCompatActivity implements PaymentResultListener {
    ViewPager viewPager;

    TextView productname, modelname, color, connectivity, harddisk, ram, brand, operatingsystem, price, warranty, processortype, manufacturer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cpu_electrobot_gaming);

        Objects.requireNonNull(getSupportActionBar()).setTitle("ELECTROBOT GAMING TOWER PC CPU");
        ...
        imageList.add(R.drawable.cpu_electrobotgaming_1);
        imageList.add(R.drawable.cpu_electrobotgaming_2);
        imageList.add(R.drawable.cpu_electrobotgaming_3);
        imageList.add(R.drawable.cpu_electrobotgaming_4);
    ...
    private void addingToCartList() {
        ...
        cartListRef.child("User Cart CPU Cart List").child("ELECTROBOT GAMING TOWER PC CPU").updateChildren(cartMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Toast.makeText(cpu_electrobot_gaming.this, "Added to cart", Toast.LENGTH_SHORT).show();
                }
                else{
                    Toast.makeText(cpu_electrobot_gaming.this, "An Error Occurred", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        buyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(cpu_electrobot_gaming.this, "You are now on RazorPay Payment Gateway", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void paymentNow(String amount) {
        ...
        checkout.setImage(R.drawable.cpu_electrobotgaming_1);
