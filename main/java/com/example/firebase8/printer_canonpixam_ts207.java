...
public class printer_canonpixam_ts207 extends AppCompatActivity implements PaymentResultListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_printer_canonpixam_ts207);

        Objects.requireNonNull(getSupportActionBar()).setTitle("CANON PIXMA TS207 INKJET PRINTER");
        ...
        imageList.add(R.drawable.pr_canonpixma_ts207_1);
        imageList.add(R.drawable.pr_canonpixma_ts207_2);
        imageList.add(R.drawable.pr_canonpixma_ts207_3);
        imageList.add(R.drawable.pr_canonpixma_ts207_2);
    ...
    private void addingToCartList() {
        ...
        cartListRef.child("User Cart PRINTER Cart List").child("CANON PIXMA TS207 INKJET PRINTER").updateChildren(cartMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Toast.makeText(printer_canonpixam_ts207.this, "Added to cart", Toast.LENGTH_SHORT).show();

                }
                else{
                    Toast.makeText(printer_canonpixam_ts207.this, "An Error Occurred", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        buyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(printer_canonpixam_ts207.this, "You are now on RazorPay Payment Gateway", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void paymentNow(String amount) {
        ...
        checkout.setImage(R.drawable.pr_canonpixma_ts207_1);
