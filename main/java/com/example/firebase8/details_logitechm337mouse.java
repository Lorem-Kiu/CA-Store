...
public class details_logitechm337mouse extends AppCompatActivity implements PaymentResultListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_details_logitechm337mouse);

        Objects.requireNonNull(getSupportActionBar()).setTitle("LOGITECH M337 OPTICAL WIRELESS MOUSE");
...
//        This is for image slider
        ...
        imageList.add(R.drawable.logitechm337_1);
        imageList.add(R.drawable.logitechm337_2);
        imageList.add(R.drawable.logitechm337_3);
        imageList.add(R.drawable.logitechm337_4);
    ...
    private void addingToCartList() {
        ...
        cartListRef.child("User Cart LOGITECH M337 OPTICAL WIRELESS MOUSE List").updateChildren(cartMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Toast.makeText(details_logitechm337mouse.this, "Added to cart", Toast.LENGTH_SHORT).show();
        ...
        buyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(details_logitechm337mouse.this, "You are now on RazorPay Payment Gateway", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void paymentNow(String amount) {
        ...
        checkout.setImage(R.drawable.logitechm337_1);
