...
public class cpu_kanget extends AppCompatActivity implements PaymentResultListener {
    ViewPager viewPager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cpu_kanget);

        progressDialog = new ProgressDialog(this);

        Objects.requireNonNull(getSupportActionBar()).setTitle("KANGET ASSEMBLE DESKTOP PC CPU");
        ...
        imageList.add(R.drawable.cpu_kanget_1);
        imageList.add(R.drawable.cpu_kanget_2);
        imageList.add(R.drawable.cpu_kanget_3);
        imageList.add(R.drawable.cpu_kanget_4);
    ...
    private void addingToCartList() {
        ...
        cartListRef.child("User Cart CPU Cart List").child("KANGET ASSEMBLE DESKTOP PC CPU").updateChildren(cartMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Toast.makeText(cpu_kanget.this, "Added to cart", Toast.LENGTH_SHORT).show();
                }
                else{
                    Toast.makeText(cpu_kanget.this, "An Error Occurred", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        buyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(cpu_kanget.this, "You are now on RazorPay Payment Gateway", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void paymentNow(String amount) {
        ...
        checkout.setImage(R.drawable.cpu_kanget_1);
