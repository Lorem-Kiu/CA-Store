...
public class keyboard_zebronic extends AppCompatActivity implements PaymentResultListener {
    ViewPager viewPager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_keyboard_zebronic);

        Objects.requireNonNull(getSupportActionBar()).setTitle("ZEBRONIC ZEB-KM2100 MULTIMEDIA USB KEYBOARD");
...
//        This is for image slider
        ...
        imageList.add(R.drawable.k_zebronic_1);
        imageList.add(R.drawable.k_zebronic_2);
        imageList.add(R.drawable.k_zebronic_3);
        imageList.add(R.drawable.k_zebronic_4);
    ...
    private void addingToCartList() {
        ...
        cartListRef.child("User Cart KEYBOARD Cart List").child("ZEBRONIC ZEB-KM2100 MULTIMEDIA USB KEYBOARD").updateChildren(cartMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Toast.makeText(keyboard_zebronic.this, "Added to cart", Toast.LENGTH_SHORT).show();

                }
                else{
                    Toast.makeText(keyboard_zebronic.this, "An Error Occurred", Toast.LENGTH_SHORT).show();
                }
            }
        });
...
// RazorPay Payment
        ...
        buyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(keyboard_zebronic.this, "You are now on RazorPay Payment Gateway", Toast.LENGTH_SHORT).show();
            }
        });
