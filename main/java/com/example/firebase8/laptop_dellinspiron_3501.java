...
public class laptop_dellinspiron_3501 extends AppCompatActivity implements PaymentResultListener {
    ViewPager viewPager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_laptop_dellinspiron3501);

        Objects.requireNonNull(getSupportActionBar()).setTitle("DELL INPIRON 3501 LAPTOP");
        ...
        imageList.add(R.drawable.lp_dellinspiron_3501_1);
        imageList.add(R.drawable.lp_dellinspiron_3501_2);
        imageList.add(R.drawable.lp_dellinspiron_3501_3);
        imageList.add(R.drawable.lp_dellinspiron_3501_4);
    ...
    private void addingToCartList() {
        ...
        cartListRef.child("User Cart LAPTOP Cart List").child("DELL INPIRON 3501 LAPTOP").updateChildren(cartMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Toast.makeText(laptop_dellinspiron_3501.this, "Added to cart", Toast.LENGTH_SHORT).show();
                }
                else{
                    Toast.makeText(laptop_dellinspiron_3501.this, "An Error Occurred", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        buyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(laptop_dellinspiron_3501.this, "You are now on RazorPay Payment Gateway", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void paymentNow(String amount) {
        ...
        checkout.setImage(R.drawable.lp_dellinspiron_3501_1);
