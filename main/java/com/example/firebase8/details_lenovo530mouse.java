...
public class details_lenovo530mouse extends AppCompatActivity implements PaymentResultListener {
    ViewPager viewPager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_details_lenovo530mouse);

        Objects.requireNonNull(getSupportActionBar()).setTitle("LENOVO 530 WIRELESS MOUSE");
...
//        This is for image slider
        ...
        imageList.add(R.drawable.lenovo530_1);
        imageList.add(R.drawable.lenovo530_2);
        imageList.add(R.drawable.lenovo530_3);
        imageList.add(R.drawable.lenovo530_4);
    ...
    private void addingToCartList() {
        ...
        cartListRef.child("User Cart LENOVO 530 WIRELESS MOUSE List").updateChildren(cartMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Toast.makeText(details_lenovo530mouse.this, "Added to cart", Toast.LENGTH_SHORT).show();
        ...
        buyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(details_lenovo530mouse.this, "You are now on RazorPay Payment Gateway", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void paymentNow(String amount) {
        ...
        checkout.setImage(R.drawable.lenovo530_1);
