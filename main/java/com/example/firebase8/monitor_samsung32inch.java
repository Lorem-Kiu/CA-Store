...
public class monitor_samsung32inch extends AppCompatActivity implements PaymentResultListener {
    ViewPager viewPager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_monitor_samsung32inch);

        Objects.requireNonNull(getSupportActionBar()).setTitle("SAMSUNG 32 INCH SMART MONITOR");
        ...
        imageList.add(R.drawable.monitor_samsung32inch_1);
        imageList.add(R.drawable.monitor_samsung32inch_2);
        imageList.add(R.drawable.monitor_samsung32inch_3);
        imageList.add(R.drawable.monitor_samsung32inch_4);
    ...
    private void addingToCartList() {
        ...
        cartListRef.child("User Cart MONITOR Cart List").child("SAMSUNG 32 INCH SMART MONITOR").updateChildren(cartMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Toast.makeText(monitor_samsung32inch.this, "Added to cart", Toast.LENGTH_SHORT).show();
                }
                else{
                    Toast.makeText(monitor_samsung32inch.this, "An Error Occurred", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        buyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(monitor_samsung32inch.this, "You are now on RazorPay Payment Gateway", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void paymentNow(String amount) {
        ...
        checkout.setImage(R.drawable.monitor_samsung32inch_1);
