...
public class laptop_applemackbookair extends AppCompatActivity implements PaymentResultListener {
    ViewPager viewPager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_laptop_applemackbookair);

        Objects.requireNonNull(getSupportActionBar()).setTitle("APPLE MACBOOK AIR LAPTOP");
        ...
        imageList.add(R.drawable.lp_applemacbookair_1);
        imageList.add(R.drawable.lp_applemacbookair_2);
        imageList.add(R.drawable.lp_applemacbookair_3);
        imageList.add(R.drawable.lp_applemacbookair_4);
    ...
    private void addingToCartList() {
        ...
        cartListRef.child("User Cart LAPTOP Cart List").child("APPLE MACBOOK AIR LAPTOP").updateChildren(cartMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Toast.makeText(laptop_applemackbookair.this, "Added to cart", Toast.LENGTH_SHORT).show();
                }
                else{
                    Toast.makeText(laptop_applemackbookair.this, "An Error Occurred", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        buyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(laptop_applemackbookair.this, "You are now on RazorPay Payment Gateway", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void paymentNow(String amount) {
        ...
        checkout.setImage(R.drawable.lp_applemacbookair_1);
