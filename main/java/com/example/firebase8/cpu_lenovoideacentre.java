...
public class cpu_lenovoideacentre extends AppCompatActivity implements PaymentResultListener {
    ViewPager viewPager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cpu_lenovoideacentre);

        progressDialog = new ProgressDialog(this);

        Objects.requireNonNull(getSupportActionBar()).setTitle("LENOVO IDEACENTRE 3 DESKTOP CPU");
        ...
        imageList.add(R.drawable.cpu_lenovoideacentre_1);
        imageList.add(R.drawable.cpu_lenovoideacentre_2);
        imageList.add(R.drawable.cpu_lenovoideacentre_3);
        imageList.add(R.drawable.cpu_lenovoideacentre_4);
    ...
    private void addingToCartList() {
        ...
        cartListRef.child("User Cart CPU Cart List").child("LENOVO IDEACENTRE 3 DESKTOP CPU").updateChildren(cartMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Toast.makeText(cpu_lenovoideacentre.this, "Added to cart", Toast.LENGTH_SHORT).show();
                }
                else{
                    Toast.makeText(cpu_lenovoideacentre.this, "An Error Occurred", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        buyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(cpu_lenovoideacentre.this, "You are now on RazorPay Payment Gateway", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void paymentNow(String amount) {
        ...
        checkout.setImage(R.drawable.cpu_lenovoideacentre_1);
