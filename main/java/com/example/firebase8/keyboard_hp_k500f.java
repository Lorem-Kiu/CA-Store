...
public class keyboard_hp_k500f extends AppCompatActivity implements PaymentResultListener {
    ViewPager viewPager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_keyboard_hp_k500f);

        progressDialog = new ProgressDialog(this);

        Objects.requireNonNull(getSupportActionBar()).setTitle("HP K500F BACKLIT MEMBRANE WIRED KEYBOARD");
...
//        This is for image slider
        ...
        imageList.add(R.drawable.k_hpk500f_1);
        imageList.add(R.drawable.k_hpk500f_2);
        imageList.add(R.drawable.k_hpk500f_3);
        imageList.add(R.drawable.k_hpk500f_4);
    ...
    private void addingToCartList() {
        ...
        cartListRef.child("User Cart KEYBOARD Cart List").child("HP K500F BACKLIT MEMBRANE WIRED KEYBOARD").updateChildren(cartMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Toast.makeText(keyboard_hp_k500f.this, "Added to cart", Toast.LENGTH_SHORT).show();

                }
                else{
                    Toast.makeText(keyboard_hp_k500f.this, "An Error Occurred", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        buyNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(keyboard_hp_k500f.this, "You are now on RazorPay Payment Gateway", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void paymentNow(String amount) {
        ...
        checkout.setImage(R.drawable.k_hpk500f_1);
